...
| Time | Session | Key move |
|---|---|---|
| 9:00–10:30 | **The average, the tool, the edge** | Land the thesis early. Teach the trust tool **once**. |
| 10:30–11:00 | *Morning tea* | |
| 11:00–12:30 | **Using AI well, yourself** | RTCF, the two-pass demo, workflow redesign. |
| 12:30–1:15 | *Lunch* | |
| 1:15–2:30 | **Why AI delivery is different** | The five differences. Reuse the trust tool at project scale. Scope a RetailFlow initiative. |
| 2:30–3:00 | *Afternoon tea* | |
| 3:00–4:00 | **Designing the human in, then shipping** | Human-in-the-loop checkpoints, roadmap, go/no-go. |
| 4:00–4:30 | **The edge that's left to humans** + action plan | Return to the opening provocation. |
...
## The two-pass demo (morning highlight)
...
- **Hands-on from minute one.** Concepts land through doing, not slides.
- **Honesty builds trust.** Be upfront about confidently-wrong output, the demo trap, and that killing is success.
- **Two scales, explicitly.** Name the morning-to-afternoon move so participants feel the coherence, not two crammed courses.
- **End on the action plan.** Trade plans between neighbours for accountability.
